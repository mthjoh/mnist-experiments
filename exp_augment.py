...
def augment(x_batch):
    ...
    # if direction == 'right':
    #     shifted[:,:,1:] = imgs[:,:,:-1]                           # your 2D right-shift line, +batch slot
    # elif direction == 'left':
    #     shifted[:,:,:-1] = imgs[:,:,1:]     
    # elif direction == 'up':
    #     shifted[:,:-1,:] = imgs[:,1:,:]    
...
with open('results_exp_augment.csv', 'w', newline='') as f:
    writer = csv.writer(f)
