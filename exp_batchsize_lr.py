...
results = {}
results['ten_batch'] = run_experiments([784, 100, 10], optimizers.Momentum(0.01, 0.9), 10001, 10)
results['hundred_batch'] = run_experiments([784, 100, 10], optimizers.Momentum(0.1, 0.9), 10001, 100)
results['thousand_batch'] = run_experiments([784, 100, 10], optimizers.Momentum(0.5, 0.9), 10001, 1000)
...
with open('results_for_batchsize_lr.csv', 'w', newline='') as f:
    writer = csv.writer(f)
